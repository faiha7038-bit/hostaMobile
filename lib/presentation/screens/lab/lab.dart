...
//   // 👉 S3 Base URL - should match your web app
...
//       if (userId == "3") {
//         log("⚠️ userId is 3, trying to get correct patientId...");
//         String? patientId = prefs.getString('patientId');
//         if (patientId != null && patientId.isNotEmpty) {
//           userId = patientId;
//           log("✅ Found patientId from storage: $userId");
//         }
//       }
...
//       log("📡 Fetching reports with userId: $userId, userType: $userType");

//       dynamic response;
      
//       log("📡 Approach 1: Fetching with patientId: $userId");
...
//           log("⚠️ No data with patientId, trying without filter");
//           response = await _apiService.getLabReports(
//             date: dateFilter,
//             page: 1,
//             limit: 100,
...
//           if (data.isNotEmpty) {
//             log("📊 First report: ${data[0]}");
//             log("📊 Report patientId: ${data[0]['patientId']}");
//             log("📊 Test results: ${data[0]['testResults']}");
//             log("📊 Image key: ${data[0]['imageKey'] ?? data[0]['imageUrl']}");
//           }
//         }
...
//             // If there's an imageKey, construct the full URL
//             if (report['imageKey'] != null && report['imageKey'].toString().isNotEmpty) {
//               report['imageUrl'] = getS3ImageUrl(report['imageKey']);
//               log("📸 Processed image URL: ${report['imageUrl']}");
//             }
//             // If there's already an imageUrl but it's just a key, construct full URL
...
//               log("📸 Processed image URL from imageUrl: ${report['imageUrl']}");
//             }
//             return report;
//           }).toList();
...
//       }
//     } catch (e) {
//       log("❌ Error fetching lab reports: $e");
//       setState(() {
...
//   // 👉 NEW: Build image viewer with S3 support
...
//                               Center(
//                                 child: Text(
//                                   selectedReport['hospital']?['name'] ?? "Dream's Medical Center",
//                                   style: TextStyle(
//                                     color: Colors.green,
...
//                                               ? "Dr. ${selectedReport['doctor']['name'] ?? 'Unknown'}" 
//                                               : "Dr. ${selectedReport['doctorId'] ?? 'Unknown'}",
//                                           screenWidth
//                                         ),
//                                         _buildDetailRow(
//                                           "Department:", 
//                                           selectedReport['department']?.toUpperCase() ?? "N/A",
//                                           screenWidth
//                                         ),
//                                         _buildDetailRow(
//                                           "Test Name:", 
...
//                                               ),
//                                               decoration: BoxDecoration(
//                                                 color: _getStatusColor(selectedReport['status'] ?? 'pending').withOpacity(0.1),
//                                                 borderRadius: BorderRadius.circular(screenWidth * 0.02),
//                                                 border: Border.all(
//                                                   color: _getStatusColor(selectedReport['status'] ?? 'pending'),
//                                                   width: 1,
//                                                 ),
//                                               ),
//                                               child: Text(
...
//                                           _buildPatientInfo(
//                                             "Patient Name:", 
//                                             selectedReport['patient']?['name'] ?? "Patient ${selectedReport['patientId'] ?? 'N/A'}",
//                                             screenWidth
//                                           ),
//                                           _buildPatientInfo(
//                                             "Patient ID:", 
//                                             "PT${selectedReport['patientId']?.toString().padLeft(3, '0') ?? '000'}",
//                                             screenWidth
//                                           ),
//                                           _buildPatientInfo(
//                                             "Age/Gender:", 
//                                             selectedReport['patient']?['age'] != null 
//                                                 ? "${selectedReport['patient']['age']} / ${selectedReport['patient']['gender'] ?? 'N/A'}"
//                                                 : "N/A",
//                                             screenWidth
//                                           ),
//                                           _buildPatientInfo(
//                                             "Blood Group:", 
//                                             selectedReport['patient']?['bloodGroup'] ?? "N/A",
//                                             screenWidth
//                                           ),
//                                         ],
//                                       ),
...
//                               // 👉 DYNAMIC TEST RESULTS TABLE (FROM BACKEND)
...
//                                   ? () {
//                                       // 👉 Download report with image if available
//                                       _downloadReport();
//                                     }
//                                   : null,
//                               child: Row(
...
//       // You can implement PDF generation or image download here
//       // For now, just show a success message
//       await Future.delayed(Duration(seconds: 1));
      
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(
//           content: Text("Downloading report #${selectedReport['id']}..."),
//           backgroundColor: Colors.green,
//         ),
//       );
      
//       // TODO: Implement actual download (PDF generation or image save)
