  ...
  void _openLocationFilter(
    ...
    showModalBottomSheet(
      ...
      builder: (context) {
        return StatefulBuilder(
          builder: (context, setModalState) {
            final modalMediaQuery = MediaQuery.of(context);
            final modalWidth = modalMediaQuery.size.width;
            final modalHeight = modalMediaQuery.size.height;
            final modalViewInsets = modalMediaQuery.viewInsets;
            ...
            return Padding(
              padding: EdgeInsets.fromLTRB(
                ...
                modalHeight * 0.02,
                modalWidth * 0.04,
                modalViewInsets.bottom + (modalHeight * 0.02),
              ),
              child: SingleChildScrollView(
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                  ...
                  children: [
                    Center(
                      child: Text(
                        "Select Location",
                        style: TextStyle(
                          fontSize: modalWidth * 0.045,
                          fontWeight: FontWeight.bold,
                        ),
                      ),
                    ),
                    SizedBox(height: modalHeight * 0.02),
                    Divider(thickness: modalWidth * 0.0025),
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      decoration: InputDecoration(
                        labelText: "Country",
                        labelStyle: TextStyle(fontSize: modalWidth * 0.035),
                        border: OutlineInputBorder(
                    ...
                    SizedBox(height: modalHeight * 0.03),
