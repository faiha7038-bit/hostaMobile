...
//     if (Platform.isAndroid) {
//       // ✅ Remove 'priority' parameter - it's not available in newer versions
...
//       enableVibration: true,
//       vibrationPattern: Int64List.fromList([0, 500, 200, 500]),
//       sound: RawResourceAndroidNotificationSound('notifications_mp3'),
//       styleInformation: BigTextStyleInformation(
//         data['message'] ?? 'You have a new notification',
//       ),
//     );
...
//       onPressed: () {
//         _testNotification(); // ✅ Test on button click
//       },
//     ),
//   ],
//         ),
...
class _NotificationsState extends State<Notifications> {
  ...
  Future<void> _initializeNotifications() async {
    try {
      ...
      if (Platform.isAndroid) {
        // ✅ FIXED: Create vibration pattern as non-const
  ...
  // ✅ FIXED: Show notification with correct parameters
  Future<void> _showLocalNotification(Map<String, dynamic> data) async {
    try {
      // ✅ FIXED: Create vibration pattern as non-const
      final vibrationPattern = Int64List(5)
