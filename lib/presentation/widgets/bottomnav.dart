...
//             child: Container(
//               padding: EdgeInsets.all(screenWidth * 0.0075),
//               decoration: BoxDecoration(
//                 color: Colors.red,
...
//             ),
//             BottomNavigationBarItem(
//  icon: IconButton(onPressed: (){}, icon:Icon(Icons.add_call,color:Colors.red ,)),
//   label: "",
// ),
//             BottomNavigationBarItem(
//               icon: _buildNotificationWithBadge(),
...
//9567900329
  ...
  Widget _buildNotificationWithBadge() {
    ...
    return Stack(
      ...
      children: [
        Icon(
          currentTabIndex == 3 ? Icons.notifications : Icons.notifications_outlined,
          color: Colors.white,
          size: screenWidth * 0.08,
        ),
        if (notificationCount > 0)
